...
| **C** Weniger DI-/Interface-Bloat | Kein `IFileReader`/`IHashService` im Code gefunden; doppelte View-Generator-Registrierung (transient + keyed) existiert. → **step-03**, **step-04** |
...
4. [`step-04-interfaces-yagni-audit.md`](step-04-interfaces-yagni-audit.md) — Restliche Abstraktionen vs. Projektrichtlinien
